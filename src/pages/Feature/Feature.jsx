...
export default function Feature({ children }) {
  ...
  const deleteFeature = async () => {
    await deleteFeatureReq(currentId);
    setConfirm(false);
    setUpdate(update + 1);
  };
      ...
      <div className="main-container">
        ...
        <Card border="light" className="table-wrapper table-responsive shadow-sm">
          <Card.Body className="pt-0">
            <DataTable value={list} tableStyle={{ minWidth: '50rem' }} size="small">
              <Column
                field="name"
                header={
                  <ColumnSortHeader
            ...
            <DeleteConfirmation
              message={<FormattedMessage id="delete-feature-confirmation-message" />}

...
const DiscountForm = ({
  ...
  discountData, // Data for editing
  onUpdate, // Callback after form submission
}) => {
  const dispatch = useDispatch()
  const { createDiscount, editDiscountRequest } = useRequest()
  ...
  const initialValues = {
    ...
    maximumDiscountAmount: discountData
      ...
      : 0,
    startDate: discountData ? discountData.startDate?.split('T')[0] : '',
    endDate: discountData ? discountData.endDate?.split('T')[0] : '',
    couponCode: discountData ? discountData.couponCode : '',
    isCumulative: discountData ? discountData.isCumulative : false,
    discountLimitation: discountData ? discountData.discountLimitation : '',
        ...
        if (type === 'create') {
          ...
          dispatch(
            discountInfo({
              ...
              data: { ...payload, isActive: false, timesUsed: 0 },
            })
          )
          setSubmitting(false)
          setVisible(false)
